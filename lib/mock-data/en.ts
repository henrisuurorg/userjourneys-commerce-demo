...
export const mockProducts: Product[] = [
  // Bags
  {
    ...
    seo: {
      title: 'Acme Drawstring Bag',
      description: 'Strong 210D ripstop nylon drawstring bag available in multiple sizes.'
    },
    tags: ['Bags'],
  ...
  // Electronics
  {
    ...
    descriptionHtml: '<p>High-quality mechanical keyboard for professional use.</p>',
    options: [
      {
  ...
  // Footwear
  {
    ...
    seo: {
      title: 'Acme Slip-On Shoes',
      description: 'Sleek, easy, and effortlessly stylish slip-on shoes for ultimate convenience.'
    },
    tags: ['Footwear'],
    updatedAt: new Date().toISOString()
  },
  {
    ...
    descriptionHtml: '<p>100% combed ringspun cotton baby cap for ultimate comfort.</p>',
    options: [
      {
  ...
  // Headwear
  {
    ...
    seo: {
      title: 'Acme Cowboy Hat',
      description: 'High-quality, weather-resistant 4X buffalo felt cowboy hat made in the USA.'
    },
    tags: ['Headwear'],
    updatedAt: new Date().toISOString()
  },
  {
    ...
    descriptionHtml: '<p>100% peach-washed cotton cap for comfortable everyday wear.</p>',
    options: [
      {
  ...
  },
  {
    ...
    seo: {
      title: 'Acme Hoodie',
      description: 'Fabric blend of Supima Cotton and Micromodal for ultimate comfort.'
    },
    tags: ['Hoodies'],
    updatedAt: new Date().toISOString()
  },
  ...
  // Jackets
  {
    ...
    seo: {
      ...
      description: 'Multi-season jacket with soft fleece lining for extra warmth.'
    },
    tags: ['Jackets'],
    updatedAt: new Date().toISOString()
  },
  ...
  },
  {
    ...
    seo: {
      title: 'Acme Pacifier',
      description: 'Thoughtfully designed pacifier for your baby\'s comfort and self-soothing.'
    },
    tags: ['Kids'],
    updatedAt: new Date().toISOString()
  },
  ...
  // Pets
  {
    ...
    seo: {
      title: 'Acme Dog Sweater',
      description: 'Soft and stretchy fleece dog sweater to keep your pet warm all winter long.'
    },
    tags: ['Pets'],
    updatedAt: new Date().toISOString()
  },
  ...
  // Shirts
  {
    ...
    seo: {
      title: 'Acme T-Shirt',
      description: '60% combed ringspun cotton/40% polyester jersey tee in multiple colors and sizes.'
    },
    tags: ['Shirts'],
    updatedAt: new Date().toISOString()
  },
  {
    ...
    seo: {
      title: 'Acme Prism T-Shirt',
      description: 'Stylish prism design T-shirt made from combed ringspun cotton and polyester blend.'
    },
    tags: ['Shirts'],
    updatedAt: new Date().toISOString()
  },
  {
    ...
    seo: {
      title: 'Acme Circles T-Shirt',
      description: 'Stylish circles design T-shirt made from combed ringspun cotton and polyester blend.'
    },
    tags: ['Shirts'],
    updatedAt: new Date().toISOString()
  },
  ...
  },
  {
    ...
    seo: {
      title: 'Acme Rainbow Sticker',
      description: 'Colorful rainbow sticker made with high-quality durable materials.'
    },
    tags: ['Stickers'],
    updatedAt: new Date().toISOString()
  }
